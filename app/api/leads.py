...
async def get_leads(
    ...
    try:
        ...
        query = get_supabase_client().client.table("leads").select("*")
...
async def get_priority_leads(
    ...
    try:
        ...
        result = get_supabase_client().client.table("leads").select("*").eq("status", "Active").execute()
        leads = result.data or []
...
async def get_lead(
    ...
    try:
        lead = get_supabase_client().get_lead_details(lead_id)
        if not lead:
            raise HTTPException(
...
async def create_lead(
    ...
    try:
        ...
        result = get_supabase_client().client.table("leads").insert(lead.dict()).execute()
...
async def update_lead(
    ...
    try:
        # Update in Supabase
        result = get_supabase_client().client.table("leads").update(
...
async def delete_lead(
    ...
    try:
        ...
        result = get_supabase_client().client.table("leads").delete().eq("id", lead_id).execute()
